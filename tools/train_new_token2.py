...
def parse_args():
    ...
    args = parser.parse_args('--cfg ../experiments/coco/capose/newtoken_m43_2dp_crossAttn2.yaml'.split())
...
def main():
    ...
    logger.info(get_model_summary(model, dump_input))           # warnings.warn("Setting attributes on ParameterList is not supported.")
